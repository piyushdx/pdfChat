...
let pdfstatus = false;
// Set up initial tab states and messages
document.getElementById("Tab1").style.display = "block";
const pdfFrameDefault = document.getElementById("pdfFrame1");
pdfFrameDefault.src = "static/pdf/US_Imaging_Guidelines.pdf";
document.getElementById("pdfFrame2").src = "";
...
function openTab(evt, tabName) {
  ...
  // Load appropriate PDF in Tab 2 if clicked
  if (tabName === 'Tab2') {
    if (pdfstatus)
    {
      document.getElementById("pdfMessage").style.display = "none";
  ...
  {
    const pdfFrame = document.getElementById("pdfFrame1");
    pdfFrame.src = "static/pdf/US_Imaging_Guidelines.pdf";
    // Hide Tab 2 PDF
    document.getElementById("pdfFrame2").src = ""; // Clear the source to ensure reload
  }
}
